...
${OBJECTDIR}/_ext/d0b9e262/JoystickReader.o: /home/doaa/NetBeansProjects/CppJNILibrary_4/JoystickReader.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -I/opt/jdk1.8.0_202/include -I/opt/jdk1.8.0_202/include/linux -std=c99 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/d0b9e262/JoystickReader.o /home/doaa/NetBeansProjects/CppJNILibrary_4/JoystickReader.c
