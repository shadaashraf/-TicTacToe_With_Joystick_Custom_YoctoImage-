 ...
 * @author shada
 */
public class XWinnerController implements Initializable {

    @FXML
    private Button VBtnX_Restart;
    ...
    @FXML
    private void HFunc_XRestart(ActionEvent event) {
        // Stop the joystick thread
        killThread();

        // Get the current stage (window) and fade out the current scene
        Stage currentStage = (Stage) VBtnX_Restart.getScene().getWindow();
